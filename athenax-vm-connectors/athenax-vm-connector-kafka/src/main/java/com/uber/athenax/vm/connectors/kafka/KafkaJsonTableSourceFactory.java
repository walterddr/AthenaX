...
import static com.uber.athenax.vm.connectors.kafka.KafkaJsonTableSource.KAFKA_JSON_TABLE_SOURCE_TYPE;
import static com.uber.athenax.vm.connectors.kafka.KafkaJsonTableSource.KAFKA_JSON_TABLE_SOURCE_VERSION;
...
public class KafkaJsonTableSourceFactory implements TableSourceFactory<Row> {
  ...
  public TableSource<Row> createTableSource(Map<String, String> properties) {
    ...
    return new KafkaJsonTableSource(topic, conf, schema);
  }
}
